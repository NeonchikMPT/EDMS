...
4. **Создайте файл `.env`**:
   ...
   > **Примечание**: Замените `your_password`, `your_secret_key`, `your_email@gmail.com` и `your_app_password` на свои значения. Для Gmail используйте [пароль приложения](#-настройка-smtp).
